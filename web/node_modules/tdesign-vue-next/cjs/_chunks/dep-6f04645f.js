...
var omit = flatRest(function (object, paths) {
  ...
  var isDeep = false;
  paths = get.arrayMap(paths, function (path) {
    path = get.castPath(path, object);
...
var TreeNode = /*#__PURE__*/function () {
  function TreeNode(tree, data, parent) {
    ...
    this.value = isNil(get.get(data, propValue)) ? this[privateKey] : get.get(data, propValue);
...
//# sourceMappingURL=dep-6f04645f.js.map
