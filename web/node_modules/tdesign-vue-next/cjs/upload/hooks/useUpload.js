...
var utils = require('../../_chunks/dep-2c1cb23b.js');
var _typeof = require('@babel/runtime/helpers/typeof');
var log = require('../../_chunks/dep-b4528c21.js');
var isFunction = require('../../_chunks/dep-ed620b03.js');
var isNumber = require('../../_chunks/dep-e41b3434.js');
require('../../_chunks/dep-449273df.js');
var configProvider_hooks_useConfig = require('../../config-provider/hooks/useConfig.js');
require('../../_chunks/dep-497fc9a5.js');
var index = require('../../_chunks/dep-d0227fbe.js');
...
function useUpload(props) {
  ...
  var uploadValue = Vue.computed(function () {
  ...
  function uploadFiles(toFiles) {
    ...
    upload({
      ...
      if (status === "success") {
        ...
        setRawValue(_toConsumableArray__default["default"](data.files), {
          trigger: "add",
          file: data.files[0]
        });
        xhrReq.value = [];
  ...
  function onInnerRemove(p) {
    ...
    if (props.isBatchUpload || !props.multiple) {
      ...
      var newVal = _toConsumableArray__default["default"](uploadValue.value);
      newVal.splice(p.index, 1);
      setRawValue(newVal, changePrams);
    } else {
      if (p.index < uploadValue.value.length) {
        var _newVal = _toConsumableArray__default["default"](uploadValue.value);
