...
import { defineComponent, getCurrentInstance, watchEffect, toRefs, ref, computed, reactive, provide, watch, onMounted, onUpdated, nextTick, onBeforeUnmount, h, createVNode, Fragment, isVNode } from 'vue';
import _toConsumableArray from '@babel/runtime/helpers/toConsumableArray';
import _slicedToArray from '@babel/runtime/helpers/slicedToArray';
import { EllipsisIcon } from 'tdesign-icons-vue-next';
import { isArray, isFunction } from 'lodash-es';
import { l as log } from '../_chunks/dep-2721b80a.js';
...
import { u as useDefaultValue } from '../_chunks/dep-b6de9ec6.js';
import '../_chunks/dep-dfeea6f5.js';
import { u as useResizeObserver } from '../_chunks/dep-b239e51b.js';
  ...
  setup: function setup(props2, ctx) {
    ...
    var _initVMenu = function initVMenu(slots, parentValue) {
      slots.forEach(function (node) {
        ...
        if (node.type === Fragment) {
          if (isArray(node.children)) {
            _initVMenu(node.children, parentValue);
          }
          return;
        }
    ...
    return function () {
      ...
      var buildPopupSlot = function buildPopupSlot() {
        var _ctx$slots$default2, _ctx$slots6, _ctx$slots$content2, _ctx$slots7;
        if (!isFolded) return [];
        var freshContent = ((_ctx$slots$default2 = (_ctx$slots6 = ctx.slots)["default"]) === null || _ctx$slots$default2 === void 0 ? void 0 : _ctx$slots$default2.call(_ctx$slots6)) || ((_ctx$slots$content2 = (_ctx$slots7 = ctx.slots).content) === null || _ctx$slots$content2 === void 0 ? void 0 : _ctx$slots$content2.call(_ctx$slots7)) || [];
        var freshFlatItems = _flattenSlotNodes(freshContent);
        ...
        }, _isSlot(freshContent) ? freshContent : {
          "default": function _default() {
            return [freshContent];
          }
        });
