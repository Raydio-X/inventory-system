...
import { u as useDestroyOnClose } from '../_chunks/dep-2c7a4735.js';
...
import { g as getScrollbarWidth } from '../_chunks/dep-a13ac6c6.js';
...
var _Dialog = defineComponent({
  ...
  setup: function setup(props2, context) {
    ...
    var cardVisible = ref(props2.visible);
    watch(function () {
      return props2.visible;
    }, function (value) {
      if (value) {
    ...
    var renderDialog = function renderDialog() {
      ...
      return createVNode("div", {
        ...
        "onMouseup": onMouseup
      }, [cardVisible.value && createVNode(_DialogCard, mergeProps({
        "ref": dialogCardRef,
        "theme": theme
      }, otherProps, {
