...
import { _ as _toConsumableArray } from '../_chunks/dep-557b68dd.mjs';
import { _ as _slicedToArray } from '../_chunks/dep-ea5fbe21.mjs';
import { d as dayjs } from '../_chunks/dep-f1da7269.mjs';
import { u as usePrefixClass, e as useDisabled, o as useReadonly } from '../_chunks/dep-9ce910b6.mjs';
...
import { g as getDefaultFormat, f as formatDate, a as formatTime, i as initYearMonthTime, p as parseToDayjs, b as isValidDate } from '../_chunks/dep-6eb7ecfc.mjs';
import { g as getRangeBounds, s as subtractMonth, a as addMonth, e as extractTimeObj } from '../_chunks/dep-93996aed.mjs';
...
import '../_chunks/dep-9b3b77bb.mjs';
...
import '../_chunks/dep-f86e55ff.mjs';
import '../_chunks/dep-578e1806.mjs';
import '../select/index.mjs';
import '../select/select.mjs';
import '../_chunks/dep-9cac91c1.mjs';
...
import '../tag/tag.mjs';
import '../_chunks/dep-a8b40385.mjs';
...
import '../_chunks/dep-ca211f37.mjs';
import '../time-picker/props.mjs';
import '../_chunks/dep-bd277a22.mjs';
import '../_chunks/dep-51cb07f0.mjs';
...
var _DateRangePicker = defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var _useRange = useRange(props2),
      ...
      onRawChange = _useRange.onRawChange;
    ...
    function onCellClick(date, _ref2) {
      ...
      if (notValidIndex === -1 && nextValue.length === 2) {
        if (!isFirstValueSelected.value && parseToDayjs(nextValue[0], formatRef.value.format).isAfter(parseToDayjs(nextValue[1], formatRef.value.format))) {
          ...
          onRawChange === null || onRawChange === void 0 || onRawChange(formatDate(nextValue, {
            format: formatRef.value.format,
    ...
    var confirmValueChange = function confirmValueChange(e) {
      ...
      if (notValidIndex === -1 && nextValue.length === 2) {
        if (!isFirstValueSelected.value && parseToDayjs(nextValue[0], formatRef.value.format).isAfter(parseToDayjs(nextValue[1], formatRef.value.format))) {
          ...
          if (!isSame) {
            onRawChange === null || onRawChange === void 0 || onRawChange(formattedValue, {
              dayjsValue: nextValue.map(function (v, i) {
    ...
    function onPresetClick(preset, context) {
      ...
      if (!isArray(presetValue)) {
        ...
        onRawChange === null || onRawChange === void 0 || onRawChange(formatDate(presetValue, {
          format: formatRef.value.format,
          targetFormat: formatRef.value.valueType,
          autoSwap: true,
          defaultTime: props2.defaultTime
