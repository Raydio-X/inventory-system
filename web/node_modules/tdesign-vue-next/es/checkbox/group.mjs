...
import { defineComponent, toRefs, computed, ref, watchEffect, provide, createVNode, mergeProps } from 'vue';
...
import { u as usePrefixClass, a as useTNodeJSX, j as useVModel, h as useChildComponentSlots } from '../_chunks/dep-9ce910b6.mjs';
...
var _Group = defineComponent({
  ...
  setup: function setup(props2) {
    ...
    var innerValue = computed(function () {
      return isArray(rawValue.value) ? rawValue.value : [];
    });
    var optionList = ref([]);
