...
import { u as usePrefixClass, a as useTNodeJSX, b as useContent, d as useRipple, m as useCollapseAnimation } from '../_chunks/dep-9ce910b6.mjs';
  ...
  setup: function setup(props2, _ref) {
    ...
    var renderPopup = function renderPopup(triggerElement) {
      ...
      var popupWrapper = createVNode("div", {
        ...
        "class": ["".concat(classPrefix.value, "-menu__popup-wrapper"), _defineProperty({}, "".concat(classPrefix.value, "-menu__popup-overflow"), isHead)]
    ...
    onBeforeUnmount(function () {
      var _menu$vMenu2;
      clearTimers();
      menu === null || menu === void 0 || (_menu$vMenu2 = menu.vMenu) === null || _menu$vMenu2 === void 0 || _menu$vMenu2.remove(props2.value);
    });
    return function () {
      var child = null;
      var events = {};
